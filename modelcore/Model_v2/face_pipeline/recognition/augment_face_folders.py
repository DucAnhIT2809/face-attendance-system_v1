...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--input-dir", type=str, default=str(REPO_ROOT / "Training"))
    parser.add_argument("--output-dir", type=str, default=str(REPO_ROOT / "TrainingAugmented"))
...
def save_report(output_dir: Path, report: Dict[str, Dict[str, int]], args: argparse.Namespace) -> None:
    ...
    payload = {
        "input_dir": _rel_under_repo(Path(args.input_dir)),
        "output_dir": _rel_under_repo(output_dir),
